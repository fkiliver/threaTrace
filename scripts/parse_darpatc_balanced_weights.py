...
os.system('cp ta1-theia-e3-official-1r.json.txt ../graphchi-cpp-master/graph_data/darpatc/theia_train_balanced_weights.txt')
os.system('cp ta1-theia-e3-official-6r.json.8.txt ../graphchi-cpp-master/graph_data/darpatc/theia_test_balanced_weights.txt')
os.system('cp ta1-cadets-e3-official.json.1.txt ../graphchi-cpp-master/graph_data/darpatc/cadets_train_balanced_weights.txt')
os.system('cp ta1-trace-e3-official-1.json.txt ../graphchi-cpp-master/graph_data/darpatc/trace_train_balanced_weights.txt')
os.system('cp ta1-trace-e3-official-1.json.4.txt ../graphchi-cpp-master/graph_data/darpatc/trace_test_balanced_weights.txt')
